...
def _file_to_word_ids(filename, word_to_id):
    ...
    result = []
    data = _read_words(filename)
    data_sentences = _read_sentences(filename)
...
def ptb_raw_data_sentence(data_path=None):
...
def ptb_sentence_producer_sentence(raw_data, batch_size, num_steps, name=None):
    ...
    """
    with tf.name_scope(name, "PTBProducer_Sentence", [raw_data, batch_size, num_steps]):
